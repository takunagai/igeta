...
function add_mgs_above_title() {
    ...
    if( is_admin() && 'post' == $typenow ) {
        echo '<p style="display:inline-block;font-size:10px;color:#FFF;background-color:rgba(0,0,0,.5);border-radius:3px;">↓(post)キーワードを入れた簡潔な記事タイトルを全角28文字以内で作成してください。</p>';
    }
